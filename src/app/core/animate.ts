export default function (app: angular.IModule) {
    ...
    app.animation('.slide', ['$timeout', function ($timeout: ng.ITimeoutService) {
        ...
        const animate: angular.animate.IAnimateCallbackObject = {
            enter: function (element: JQuery, doneFunction: Function, options: angular.animate.IAnimationOptions) {
            ...
            leave: function (element: JQuery, doneFunction: Function, options: angular.animate.IAnimationOptions) {
                if (!element.parent().hasClass('back')) {
                    element.css({
